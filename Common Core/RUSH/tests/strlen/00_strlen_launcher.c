...
/*   Updated: 2025/07/06 03:49:39 by netrunner        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int strlen_launcher(void)
{
	...
	list->size = 0;
	list->routine = "STRLEN";
	load_test(list, "OK Test", &ok_test_strlen, true);
	load_test(list, "KO Test", &ko_test_strlen, true);
/* 	load_test(list, "SEGFAULT Test", &segfault_test_strlen, true);
	load_test(list, "SIGBUS Test", &sigbus_test_strlen, true); */
